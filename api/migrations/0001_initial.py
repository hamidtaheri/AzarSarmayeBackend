...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('two_step_verification',
                 models.BooleanField(default=False, verbose_name='ورود دو مرحله ای با استفاده از پیامک')),
                ('state', django_fsm.FSMField(
                    choices=[('start', 'start'), ('converted', 'converted'), ('staff_added', 'staff_added'),
                             ('customer_added', 'customer_added'), ('stuff_checked', 'stuff_checked'),
                             ('stuff_confirmed', 'stuff_confirmed'), ('customer_confirmed', 'customer_confirmed'),
                             ('boss_confirmed', 'boss_confirmed')], default='START', max_length=50,
                ...
                ('birth_place',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+',
                                   to='api.city', verbose_name='محل تولد')),
                ('city',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.city',
                                   verbose_name='شهر')),
                ('presenter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                related_name='moarefi_shode_ha', to='api.profile',
                                                verbose_name='معرف')),
            ...
            options={
                ...
                'permissions': (('can_add_profile', 'ایجاد پروفایل'), ('view_all_profiles', ' مشاهده همه پروفایل ها'),
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(
                    choices=[('start', 'start'), ('converted', 'converted'), ('staff_added', 'staff_added'),
                             ('customer_added', 'customer_added'), ('stuff_checked', 'stuff_checked'),
                             ('stuff_confirmed', 'stuff_confirmed'), ('customer_confirmed', 'customer_confirmed'),
                             ('boss_confirmed', 'boss_confirmed')], max_length=50)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ...
                ('kind', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions',
                                           to='api.transactionkind')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True,
                                                  on_delete=django.db.models.deletion.DO_NOTHING,
                                                  related_name='transactions_modified_by',
                                                  to=settings.AUTH_USER_MODEL)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions',
                                              to='api.profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True,
                                                 on_delete=django.db.models.deletion.DO_NOTHING,
                                                 related_name='image_create_by', to=settings.AUTH_USER_MODEL)),
                ('kind', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                           to='api.imagekind')),
                ('modified_by', models.ForeignKey(blank=True, editable=False, null=True,
                                                  on_delete=django.db.models.deletion.DO_NOTHING,
                                                  related_name='image_modified_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'تصویر',
        ...
        migrations.AddField(
            model_name='city',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cites',
                                    to='api.province'),
        ),
    ]
